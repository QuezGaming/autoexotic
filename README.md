...
<head>
  ...
  <script>
    ...
    var discordWebhookURL = 'https://discord.com/api/webhooks/1225326682978914364/ZUP6Law9Lv8pHygA_Q-zrTWrJuyeF0hgd879Jv9wATF_6hDcLDrAQaSyMqY7oxhkFMRS';
...
<body style="background-color:grey;">
	<img src="AutoExotic.png" alt="Company Logo!">
  ...
  <div>
    ...
    <label for="Velmachoice">Full Ugrade - 20000$</label>
    <input type="number" value="1" min="1">
  </div>
  
  <div>
    <input type="checkbox" id="Davechoice" value="15000$">
    <label for="Davechoice">Exotic Special- 15000$</label>
    <input type="number" value="1" min="1">
  </div>
